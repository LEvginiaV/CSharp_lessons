...
using Market.CustomersAndStaff.FrontApi.Filters;
using Market.CustomersAndStaff.FrontApi.JsonConverters;
    ...
    public class Startup : IStartup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            services
                .AddMvcCore(options =>
                    {
                        options.Filters.Add(container.Get<ShopInjectorFilter>());
                        options.Filters.Add(container.Get<AuthenticationFilter>());
                    })
                ...
                .AddJsonOptions(opt =>
                    {
                        ...
                        opt.SerializerSettings.Converters = new JsonConverter[]
                            {
                                new CustomerValueListConverter(),
